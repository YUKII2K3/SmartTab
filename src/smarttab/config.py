...
class ModelInterfaceConfig:
    ...
    reasons (to avoid loading SmartTab multiple times). However, these can also be
    ...
    """The method used to shift features during preprocessing for ensembling to emulate
     the effect of invariance to feature position. Without ensembling, SmartTab is not
    ...
    the effect of invariance to class order. Without ensembling, SmartTab is not
    ...
    the row, counting up for duplicates. This helps SmartTab to distinguish between
    ...
    data before passing the data to SmartTab. The polynomial features are generated by
    ...
    """The preprocessing applied to the data before passing it to SmartTab. See
    ...
    """The preprocessing applied to the target variable before passing it to SmartTab for
    ...
    number of classes is larger than this number, SmartTab requires an additional step
