...
from smarttab.model.bar_distribution import FullSupportBarDistribution, BarDistribution
from smarttab.model.preprocessing import (
    CategoricalPreprocessor,
    NumericalPreprocessor,
    OrdinalPreprocessor,
    SequentialFeatureTransformer,
)
from smarttab.utils import infer_random_state
...
class ClassifierEnsembleConfig(EnsembleConfig):
    ...
    See [EnsembleConfig][smarttab.preprocessing.EnsembleConfig] for more details.
    """
    ...
    def __getitem__(self, index):  # noqa: C901, PLR0912
        ...
        Returns:
            Tuple: A tuple containing the processed data and metadata. Each
                ...
                of estimators in the SmartTab ensemble. As such each element
