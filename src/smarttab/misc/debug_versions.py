...
def _get_deps_info():
    ...
    try:
        __version__ = get_version("smarttab")
    except ImportError:
        __version__ = "unknown"

    deps_info = {
        "smarttab": __version__,
    }
