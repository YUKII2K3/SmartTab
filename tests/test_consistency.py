"""Model consistency tests for SmartTab.

These tests verify that SmartTab models produce consistent predictions across code
...
# mypy: ignore-errors
from smarttab import SmartTabClassifier, SmartTabRegressor  # type: ignore
...
class ConsistencyTest:
    ...
    3. get_model() - returns the SmartTab model to test with
